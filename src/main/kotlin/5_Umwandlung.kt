fun main () {
     ...
     *
     */
    var grosseZahl = (unserErsterInteger.toString() + unserZweiterInteger.toString()).toInt() //33
    var auchGrosseZahl = (unserZweiterInteger.toString() + unserDritterInteger.toString()).toInt() //14
    var nichtGanzSoGrosseZahl = grosseZahl + auchGrosseZahl.toDouble() / 2 //23 oder Exeption
